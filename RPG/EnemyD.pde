class EnemyD extends Enemy
{
  ...
  void show()
  {
    ...
    if (millis() - shootTime - pauseTime >= 1500)
    {
      ...
      bullets.add(new Bullet(new PVector(loc2.x, loc2.y), new PVector(shotSpread.x, shotSpread.y), new PVector(loc2.x, loc2.y), new PVector(), 5, millis() - pauseTime, -1, 2, 275, -1, -1, -1, 4.0, false, false, false, false, true, true, true));
